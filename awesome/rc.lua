...
globalkeys = mytable.join(
    ...
    awful.key({ modkey, "Control" }, "q", function () awful.spawn.with_shell("lock_screen") end,
              {description = "lock screen", group = "hotkeys"}),
    -- User programs
    ...
    awful.key({ modkey, "Shift" }, "p", function ()
            os.execute(string.format("rofi -combi-modi window,drun -show %s -theme %s -show-icons -icon-theme 'Papirus'",
            'combi', 'nord'))
        end,
        {description = "show rofi", group = "launcher"}),
    
    awful.key({ modkey, "Shift" }, "o", function ()
            os.execute(string.format("rofi -show %s -theme %s -show-icons -icon-theme 'Papirus'",
            'filebrowser', 'nord'))
        end,
        {description = "show rofi", group = "launcher"}),
